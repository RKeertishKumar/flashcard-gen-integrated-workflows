...
def index():
    ...
    selected_grade = "5"  # Default value for selected_grade
    selected_subject = "Maths"  # Default value for selected_subject
    language = "English"
    ...
    if request.method == "POST":
        ...
        for sentence in sentences:
            ...
            if language != "English":
                translated_sentence = translate_to(sentence,language)
                input_texts_ts.append(translated_sentence)
